function msg=bpsk_rx_func(rxdata,data_16_length)
global cyc;
global debug_level;
...
%% package search
[rx_frame,cor_abs,th_max,index_s]=rx_package_search(rx_sig_down,local_sync,144*data_16_length+127); 
...
%% delete pilot
out_signal7=rx_delete_pilot(out_signal6,data_16_length);
%% time domain equalize
out_signal8=rx_time_equalize(out_signal7,data_16_length);
%% signal demod
